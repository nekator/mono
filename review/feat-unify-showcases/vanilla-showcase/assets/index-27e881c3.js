(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();class m extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/icon/icon-wc.css"},this.props||(this.props={}),this.componentProps=["className","icntxt","icon","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),o=new RegExp(e,"i");this.componentProps.forEach(n=>{if(o.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
	...
	`);const x=()=>(window.addEventListener("load",()=>{const s=document.querySelector("#select-variant"),t=Array.from(document.querySelectorAll("db-button"));s&&s.addEventListener("change",e=>{for(const o of t)o.setAttribute("variant",e.target.value)})}),`
	<div>
		<h1>Button</h1>
	...
	</div>`);const b=()=>document.location.search.slice(1).split("&").filter(s=>(s==null?void 0:s.length)>0).reduce((s,t)=>{const e=t.split("=");return{...s,[e[0]]:e[1]}},{}),T=()=>(window.addEventListener("load",()=>{const s=b();["primary","secondary","success","critical","warning","information"].some(t=>t.includes(s.color??""))?document.querySelector("#backgroundWarning").style.display="block":document.querySelector("#backgroundWarning").style.display="none"}),`
	<div>
		<h1>Input</h1>
      ...
      <div data-el="div-db-brand-1">
        ...
        <a data-el="a-db-brand-1">
          <img data-el="img-db-brand-1" />
      
          <template data-el="show-db-brand-2">
            <span class="site-name"><slot></slot></span>
          </template>
        </a>
      ...
      </div>`,this.pendingUpdate=!0,this.render(),this.onMount(),this.pendingUpdate=!1,this.update()}showContent(t){const e=t.content.cloneNode(!0);Array.from(e.childNodes).forEach(n=>{t!=null&&t.scope&&(n.scope=t.scope),t!=null&&t.context&&(n.context=t.context),this.nodesToDestroy.push(n)}),t.after(e)}attributeChangedCallback(t,e,o){this.props[t]=o,this.update()}static get observedAttributes(){return[]}onMount(){this.props.stylePath&&(this.state.stylePath=this.props.stylePath,this.update())}onUpdate(){}update(){this.pendingUpdate!==!0&&(this.pendingUpdate=!0,this.render(),this.onUpdate(),this.pendingUpdate=!1)}render(){this.destroyAnyNodes(),this.updateBindings()}updateBindings(){this._root.querySelectorAll("[data-el='div-db-brand-1']").forEach(t=>{t.className="db-brand"+(this.props.className?" "+this.props.className:"")}),this._root.querySelectorAll("[data-el='show-db-brand']").forEach(t=>{this.state.stylePath&&this.showContent(t)}),this._root.querySelectorAll("[data-el='link-db-brand-1']").forEach(t=>{t.setAttribute("href",this.state.stylePath)}),this._root.querySelectorAll("[data-el='a-db-brand-1']").forEach(t=>{(this.props.anchorRef??d.anchorRef)&&t.setAttribute("href",this.props.anchorRef??d.anchorRef),this.props.anchorTitle&&t.setAttribute("title",this.props.anchorTitle),this.props.anchorRelation&&t.setAttribute("rel",this.props.anchorRelation)}),this._root.querySelectorAll("[data-el='img-db-brand-1']").forEach(t=>{(this.props.imgSrc??d.src)&&t.setAttribute("src",this.props.imgSrc??d.src),this.props.imgAlt&&t.setAttribute("alt",this.props.imgAlt),this.props.imgHeight&&t.setAttribute("height",this.props.imgHeight),this.props.imgWidth&&t.setAttribute("width",this.props.imgWidth),t.className="db-logo"+(this.props.insideHeader?" inside-header":"")}),this._root.querySelectorAll("[data-el='show-db-brand-2']").forEach(t=>{this.props.anchorChildren&&this.showContent(t)}),this._root.querySelectorAll("[data-el='show-db-brand-3']").forEach(t=>{!this.props.anchorChildren&&this.showContent(t)})}renderTextNode(t,e){const o=document.createTextNode(e);t!=null&&t.scope&&(o.scope=t.scope),t!=null&&t.context&&(o.context=t.context),t.after(o),this.nodesToDestroy.push(t.nextSibling)}}customElements.define("db-brand",w);const f=(s,t)=>`db-ui-${s} db-bg-${t}`,u=(s,t,e)=>{t=encodeURIComponent(t),e=encodeURIComponent(e),s[t]=e;const o=Object.keys(s).map(n=>`${n}=${s[n]}`);document.location.search=o.join("&")};onload=()=>{const s=document.querySelector("#select-tonality"),t=document.querySelector("#select-color"),e=document.querySelector("#content"),o=b(),n=o.tonality??"regular",i=o.color??"neutral-0";e.className=f(n,i),s&&(s.value=n,s.addEventListener("change",r=>{u(o,"tonality",r.target.value)})),t&&(t.value=i,t.addEventListener("change",r=>{u(o,"color",r.target.value)}))};const I=s=>`
	<db-page type="fixedHeaderFooter">
		<db-header slot="header">
			...
			<nav slot="desktop-navigation" class="desktop-navigation">
				<ul>
					${h.map(t=>`<li><a href="/vanilla-showcase/${t.path}">${t.label}</a></li>`).join("")}
				</ul>
			</nav>
...
`,C=()=>{const s=h.filter(t=>t.path!=="/").find(t=>window.location.href.includes(t.path));return s?s.component():h[0].component()};document.querySelector("#app").innerHTML=I(C());
