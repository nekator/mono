(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();class y extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/icon/icon-web-component.css"},this.props||(this.props={}),this.componentProps=["className","icntxt","icon","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
	...
	`),_=()=>(window.addEventListener("load",()=>{const o=document.querySelector("#select-variant"),t=Array.from(document.querySelectorAll("db-button"));o&&o.addEventListener("change",e=>{for(const s of t)s.setAttribute("variant",e.target.value)})}),`
	<div>
		<h1>Button</h1>
	...
	</div>`),b={button:"/button",input:"/input"},c=[{path:"/",label:"Home",component:S},{path:b.button,label:"Button",component:_},{path:b.input,label:"Input",component:x}];class w extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/page/page.css"},this.props||(this.props={}),this.componentProps=["className","type","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
...
`,U=()=>{const o=c.filter(t=>t.path!=="/").find(t=>window.location.href.includes(t.path));return o?o.component():c[0].component()};document.querySelector("#app").innerHTML=P(U());
