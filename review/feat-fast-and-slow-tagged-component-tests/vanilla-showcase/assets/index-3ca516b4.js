(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();class A extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/icon/icon-web-component.css"},this.props||(this.props={}),this.componentProps=["className","icntxt","icon","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
      <span aria-hidden="true" data-el="span-db-icon-1">
        ...
        <slot></slot>
      </span>`,this.pendingUpdate=!0,this.render(),this.onMount(),this.pendingUpdate=!1,this.update()}showContent(t){const e=t.content.cloneNode(!0);Array.from(e.childNodes).forEach(n=>{t!=null&&t.scope&&(n.scope=t.scope),t!=null&&t.context&&(n.context=t.context),this.nodesToDestroy.push(n)}),t.after(e)}attributeChangedCallback(t,e,s){this.props[t]=s,this.update()}static get observedAttributes(){return["icon","icntxt"]}onMount(){this.props.stylePath&&(this.state.stylePath=this.props.stylePath,this.update())}onUpdate(){}update(){this.pendingUpdate!==!0&&(this.pendingUpdate=!0,this.render(),this.onUpdate(),this.pendingUpdate=!1)}render(){this.destroyAnyNodes(),this.updateBindings()}updateBindings(){this._root.querySelectorAll("[data-el='span-db-icon-1']").forEach(t=>{t.className="db-icon"+(this.props.className?" "+this.props.className:"")+(this.props.icntxt?"":" is-icon-text-replace"),this.props.icon&&t.setAttribute("data-icon",this.props.icon)}),this._root.querySelectorAll("[data-el='show-db-icon']").forEach(t=>{this.state.stylePath&&this.showContent(t)}),this._root.querySelectorAll("[data-el='link-db-icon-1']").forEach(t=>{t.setAttribute("href",this.state.stylePath)})}renderTextNode(t,e){const s=document.createTextNode(e);t!=null&&t.scope&&(s.scope=t.scope),t!=null&&t.context&&(s.context=t.context),t.after(s),this.nodesToDestroy.push(t.nextSibling)}}customElements.define("db-icon",A);const v=()=>{var o;return((o=window==null?void 0:window.crypto)==null?void 0:o.randomUUID())||Math.random().toString()},E="ID_WILL_BE_OVERWRITTEN_ON_MOUNT_AND_THIS_CONSTANT_WONT_SHOW_UP_ONLY_IF_YOU_ARENT_INITIALIZING_IT_IN_THE_FRONTEND";var p;(function(o){o.FUNCTIONAL="functional",o.REGULAR="regular",o.EXPRESSIVE="expressive"})(p||(p={}));Object.entries(p).map(([,o])=>o);var h;(function(o){o.PRIMARY="primary"})(h||(h={}));var a;(function(o){o.NEUTRAL_0="neutral-0",o.NEUTRAL_1="neutral-1",o.NEUTRAL_2="neutral-2",o.NEUTRAL_3="neutral-3",o.NEUTRAL_4="neutral-4",o.NEUTRAL_5="neutral-5",o.NEUTRAL_6="neutral-6",o.NEUTRAL_TRANSPARENT_FULL="neutral-transparent-full",o.NEUTRAL_TRANSPARENT_SEMI="neutral-transparent-semi",o.PRIMARY="primary",o.PRIMARY_LIGHT="primary-light",o.PRIMARY_TRANSPARENT_SEMI="primary-transparent-semi",o.SECONDARY="secondary",o.SECONDARY_LIGHT="secondary-light",o.SECONDARY_TRANSPARENT_SEMI="secondary-transparent-semi",o.SUCCESS="success",o.SUCCESS_LIGHT="success-light",o.SUCCESS_TRANSPARENT_SEMI="success-transparent-semi",o.CRITICAL="critical",o.CRITICAL_LIGHT="critical-light",o.CRITICAL_TRANSPARENT_SEMI="critical-transparent-semi",o.WARNING="warning",o.WARNING_LIGHT="warning-light",o.WARNING_TRANSPARENT_SEMI="warning-transparent-semi",o.INFORMATION="information",o.INFORMATION_LIGHT="information-light",o.INFORMATION_TRANSPARENT_SEMI="information-transparent-semi"})(a||(a={}));Object.entries(a).map(([,o])=>o);Object.entries(h).map(([,o])=>o);var c;(function(o){o.CRITICAL="critical",o.INFORMATION="information",o.WARNING="warning",o.SUCCESS="success"})(c||(c={}));Object.entries(c).map(([,o])=>o);a.PRIMARY,a.SECONDARY,a.SUCCESS,a.WARNING,a.CRITICAL,a.INFORMATION;const N={critical:"error",warning:"error-triangle",success:"check-circle",information:"info"};class S extends HTMLElement{get _textInputRef(){return this._root.querySelector("[data-ref='DBInput-textInputRef']")}get _root(){return this.shadowRoot||this}constructor(){super();const t=this;this.state={stylePath:"components/input/input.css",mId:E,_isValid:void 0,_value:"",_placeholder:" ",_label:"LABEL SHOULD BE SET",getIcon(e){return e?N[e]:""},handleChange(e){var s,n,i,r,u,b;t.props.onChange&&t.props.onChange(e),t.props.change&&t.props.change(e),t.state._value=e.target.value,t.update(),((n=(s=t._textInputRef)==null?void 0:s.validity)==null?void 0:n.valid)!=t.state._isValid&&(t.state._isValid=(r=(i=t._textInputRef)==null?void 0:i.validity)==null?void 0:r.valid,t.update(),t.props.validityChange&&typeof t.props.validityChange=="function"&&t.props.validityChange(!!((b=(u=t._textInputRef)==null?void 0:u.validity)!=null&&b.valid)))},handleBlur(e){t.props.onBlur&&t.props.onBlur(e),t.props.blur&&t.props.blur(e)},handleFocus(e){t.props.onFocus&&t.props.onFocus(e),t.props.focus&&t.props.focus(e)}},this.props||(this.props={}),this.componentProps=["onChange","change","validityChange","onBlur","blur","onFocus","focus","className","variant","iconBefore","name","type","disabled","required","maxLength","minLength","pattern","description","iconAfter","id","value","stylePath","placeholder","label"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.onInputDbInput1Input=e=>{this.state.handleChange(e)},this.onInputDbInput1Blur=e=>{this.state.handleBlur(e)},this.onInputDbInput1Focus=e=>{this.state.handleFocus(e)},this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
	...
	`),w=()=>(window.addEventListener("load",()=>{const o=document.querySelector("#select-variant"),t=Array.from(document.querySelectorAll("db-button"));o&&o.addEventListener("change",e=>{for(const s of t)s.setAttribute("variant",e.target.value)})}),`
	<div>
		<h1>Button</h1>
	...
	</div>`),g=()=>document.location.search.slice(1).split("&").filter(o=>(o==null?void 0:o.length)>0).reduce((o,t)=>{const e=t.split("=");return{...o,[e[0]]:e[1]}},{}),_=()=>(window.addEventListener("load",()=>{const o=g();["primary","secondary","success","critical","warning","information"].some(t=>t.includes(o.color??""))?document.querySelector("#backgroundWarning").style.display="block":document.querySelector("#backgroundWarning").style.display="none"}),`
	<div>
		<h1>Input</h1>
	...
	</div>`),f={button:"/button",input:"/input"},l=[{path:"/",label:"Home",component:T},{path:f.button,label:"Button",component:w},{path:f.input,label:"Input",component:_}];class I extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/page/page.css"},this.props||(this.props={}),this.componentProps=["className","type","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
...
`,D=()=>{const o=l.filter(t=>t.path!=="/").find(t=>window.location.href.includes(t.path));return o?o.component():l[0].component()};document.querySelector("#app").innerHTML=U(D());
