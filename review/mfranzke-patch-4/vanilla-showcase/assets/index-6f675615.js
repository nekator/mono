...
`,D=()=>{const o=h.filter(t=>t.path!=="/").find(t=>window.location.href.includes(t.path));return o?o.component():h[0].component()};document.querySelector("#app").innerHTML=I(D());
