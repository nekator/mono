(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();class A extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/icon/icon-web-component.css"},this.props||(this.props={}),this.componentProps=["className","icntxt","icon","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
      <span aria-hidden="true" data-el="span-db-icon-1">
        ...
        <slot></slot>
      </span>`,this.pendingUpdate=!0,this.render(),this.onMount(),this.pendingUpdate=!1,this.update()}showContent(t){const e=t.content.cloneNode(!0);Array.from(e.childNodes).forEach(n=>{t!=null&&t.scope&&(n.scope=t.scope),t!=null&&t.context&&(n.context=t.context),this.nodesToDestroy.push(n)}),t.after(e)}attributeChangedCallback(t,e,s){this.props[t]=s,this.update()}static get observedAttributes(){return["icon","icntxt"]}onMount(){this.props.stylePath&&(this.state.stylePath=this.props.stylePath,this.update())}onUpdate(){}update(){this.pendingUpdate!==!0&&(this.pendingUpdate=!0,this.render(),this.onUpdate(),this.pendingUpdate=!1)}render(){this.destroyAnyNodes(),this.updateBindings()}updateBindings(){this._root.querySelectorAll("[data-el='span-db-icon-1']").forEach(t=>{t.className="db-icon"+(this.props.className?" "+this.props.className:"")+(this.props.icntxt?"":" is-icon-text-replace"),this.props.icon&&t.setAttribute("data-icon",this.props.icon)}),this._root.querySelectorAll("[data-el='show-db-icon']").forEach(t=>{this.state.stylePath&&this.showContent(t)}),this._root.querySelectorAll("[data-el='link-db-icon-1']").forEach(t=>{t.setAttribute("href",this.state.stylePath)})}renderTextNode(t,e){const s=document.createTextNode(e);t!=null&&t.scope&&(s.scope=t.scope),t!=null&&t.context&&(s.context=t.context),t.after(s),this.nodesToDestroy.push(t.nextSibling)}}customElements.define("db-icon",A);const E=()=>{var o;return typeof window<"u"?(o=window.crypto)==null?void 0:o.randomUUID():Math.random().toString()},N="ID_WILL_BE_OVERWRITTEN_ON_MOUNT_AND_THIS_CONSTANT_WONT_SHOW_UP_ONLY_IF_YOU_ARENT_INITIALIZING_IT_IN_THE_FRONTEND";var d;(function(o){o.FUNCTIONAL="functional",o.REGULAR="regular",o.EXPRESSIVE="expressive"})(d||(d={}));Object.entries(d).map(([,o])=>o);var p;(function(o){o.NEUTRAL_0="neutral-0",o.NEUTRAL_1="neutral-1",o.NEUTRAL_2="neutral-2",o.NEUTRAL_3="neutral-3",o.NEUTRAL_4="neutral-4",o.NEUTRAL_TRANSPARENT_FULL="neutral-transparent-full",o.NEUTRAL_TRANSPARENT_SEMI="neutral-transparent-semi",o.PRIMARY="primary",o.PRIMARY_TRANSPARENT_FULL="primary-transparent-full",o.PRIMARY_TRANSPARENT_SEMI="primary-transparent-semi",o.SECONDARY="secondary",o.SECONDARY_TRANSPARENT_FULL="secondary-transparent-full",o.SECONDARY_TRANSPARENT_SEMI="secondary-transparent-semi",o.SUCCESS="success",o.SUCCESS_TRANSPARENT_FULL="success-transparent-full",o.SUCCESS_TRANSPARENT_SEMI="success-transparent-semi",o.CRITICAL="critical",o.CRITICAL_TRANSPARENT_Full="critical-transparent-full",o.CRITICAL_TRANSPARENT_SEMI="critical-transparent-semi",o.WARNING="warning",o.WARNING_TRANSPARENT_FULL="warning-transparent-full",o.WARNING_TRANSPARENT_SEMI="warning-transparent-semi",o.INFORMATION="information",o.INFORMATION_TRANSPARENT_FULL="information-transparent-full",o.INFORMATION_TRANSPARENT_SEMI="information-transparent-semi"})(p||(p={}));Object.entries(p).map(([,o])=>o);var h;(function(o){o.CRITICAL="critical",o.INFORMATION="information",o.WARNING="warning",o.SUCCESS="success"})(h||(h={}));Object.entries(h).map(([,o])=>o);const v={critical:"error",warning:"error-triangle",success:"check-circle",information:"info"},b={label:DEFAULT_LABEL,placeholder:" "};class w extends HTMLElement{get _textInputRef(){return this._root.querySelector("[data-ref='DBInput-textInputRef']")}get _root(){return this.shadowRoot||this}constructor(){super();const t=this;this.state={stylePath:"components/input/input-web-component.css",_id:N,_isValid:void 0,_value:"",iconVisible(e){return e&&e!=="_"&&e!=="none"},getIcon(e){return e?v[e]:""},handleChange(e){var s,n,i,r,l,u;t.props.onChange&&t.props.onChange(e),t.props.change&&t.props.change(e),t.state._value=e.target.value,t.update(),((n=(s=t._textInputRef)==null?void 0:s.validity)==null?void 0:n.valid)!=t.state._isValid&&(t.state._isValid=(r=(i=t._textInputRef)==null?void 0:i.validity)==null?void 0:r.valid,t.update(),t.props.validityChange&&typeof t.props.validityChange=="function"&&t.props.validityChange(!!((u=(l=t._textInputRef)==null?void 0:l.validity)!=null&&u.valid)))},handleBlur(e){t.props.onBlur&&t.props.onBlur(e),t.props.blur&&t.props.blur(e)},handleFocus(e){t.props.onFocus&&t.props.onFocus(e),t.props.focus&&t.props.focus(e)}},this.props||(this.props={}),this.componentProps=["onChange","change","validityChange","onBlur","blur","onFocus","focus","className","variant","icon","name","type","placeholder","disabled","required","maxLength","minLength","pattern","label","description","iconAfter","id","value","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.onInputDbInput1Input=e=>{this.state.handleChange(e)},this.onInputDbInput1Blur=e=>{this.state.handleBlur(e)},this.onInputDbInput1Focus=e=>{this.state.handleFocus(e)},this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
      <div data-el="div-db-input-1">
        ...
        <label aria-hidden="true" data-el="label-db-input-1">
          <span>
            <template data-el="div-db-input-2">
      ...
      </div>`,this.pendingUpdate=!0,this.render(),this.onMount(),this.pendingUpdate=!1,this.update()}showContent(t){const e=t.content.cloneNode(!0);Array.from(e.childNodes).forEach(n=>{t!=null&&t.scope&&(n.scope=t.scope),t!=null&&t.context&&(n.context=t.context),this.nodesToDestroy.push(n)}),t.after(e)}attributeChangedCallback(t,e,s){this.props[t]=s,this.update()}static get observedAttributes(){return["label","placeholder","value","icon","iconAfter","variant"]}onMount(){this.state._id=this.props.id?this.props.id:"input-"+E(),this.update(),this.props.value&&(this.state._value=this.props.value,this.update()),this.props.stylePath&&(this.state.stylePath=this.props.stylePath,this.update())}onUpdate(){}update(){this.pendingUpdate!==!0&&(this.pendingUpdate=!0,this.render(),this.onUpdate(),this.pendingUpdate=!1)}render(){const t=this.getStateful(this._root),e=this.prepareHydrate(t);if(this.destroyAnyNodes(),this.updateBindings(),e.length){const s=this.getStateful(this._root);this.hydrateDom(e,s)}}getStateful(t){const e=t.querySelectorAll("[data-dom-state]");return e?Array.from(e):[]}prepareHydrate(t){return t.map(e=>({id:e.dataset.domState,value:e.value,active:document.activeElement===e,selectionStart:e.selectionStart}))}hydrateDom(t,e){return e.map((s,n)=>{const i=t.find(r=>s.dataset.domState===r.id);i&&(s.value=i.value,i.active&&(s.focus(),s.selectionStart=i.selectionStart))})}updateBindings(){this._root.querySelectorAll("[data-el='div-db-input-1']").forEach(t=>{t.className="db-input "+(this.props.className||""),this.props.variant&&t.setAttribute("data-variant",this.props.variant)}),this._root.querySelectorAll("[data-el='show-db-input']").forEach(t=>{this.state.stylePath&&this.showContent(t)}),this._root.querySelectorAll("[data-el='link-db-input-1']").forEach(t=>{t.setAttribute("href",this.state.stylePath)}),this._root.querySelectorAll("[data-el='show-db-input-2']").forEach(t=>{this.state.iconVisible(this.props.icon)&&this.showContent(t)}),this._root.querySelectorAll("[data-el='db-icon-db-input']").forEach(t=>{this.props.icon&&t.setAttribute("icon",this.props.icon)}),this._root.querySelectorAll("[data-el='input-db-input-1']").forEach(t=>{t.setAttribute("id",this.state._id),this.props.name&&t.setAttribute("name",this.props.name),this.props.type,t.setAttribute("type",this.props.type||"text"),t.setAttribute("placeholder",this.props.placeholder??b.placeholder),t.setAttribute("aria-labelledby",this.state._id+"-label"),this.props.disabled&&t.setAttribute("disabled",this.props.disabled),this.props.required&&t.setAttribute("required",this.props.required),t.value=this.state._value,this.props.maxLength&&t.setAttribute("maxLength",this.props.maxLength),this.props.minLength&&t.setAttribute("minLength",this.props.minLength),this.props.pattern&&t.setAttribute("pattern",this.props.pattern),t.removeEventListener("input",this.onInputDbInput1Input),t.addEventListener("input",this.onInputDbInput1Input),t.removeEventListener("blur",this.onInputDbInput1Blur),t.addEventListener("blur",this.onInputDbInput1Blur),t.removeEventListener("focus",this.onInputDbInput1Focus),t.addEventListener("focus",this.onInputDbInput1Focus)}),this._root.querySelectorAll("[data-el='label-db-input-1']").forEach(t=>{t.setAttribute("for",this.state._id),t.setAttribute("id",this.state._id+"-label")}),this._root.querySelectorAll("[data-el='div-db-input-2']").forEach(t=>{this.renderTextNode(t,this.props.label??b.label)}),this._root.querySelectorAll("[data-el='show-db-input-3']").forEach(t=>{this.props.description&&this.showContent(t)}),this._root.querySelectorAll("[data-el='div-db-input-3']").forEach(t=>{this.renderTextNode(t,this.props.description)}),this._root.querySelectorAll("[data-el='show-db-input-4']").forEach(t=>{(this.props.variant||this.props.required||this.props.pattern)&&this.showContent(t)}),this._root.querySelectorAll("[data-el='db-icon-db-input-2']").forEach(t=>{t.setAttribute("icon",this.state.getIcon(this.props.variant))}),this._root.querySelectorAll("[data-el='show-db-input-5']").forEach(t=>{this.state.iconVisible(this.props.iconAfter)&&this.showContent(t)}),this._root.querySelectorAll("[data-el='db-icon-db-input-3']").forEach(t=>{this.props.iconAfter&&t.setAttribute("icon",this.props.iconAfter)})}renderTextNode(t,e){const s=document.createTextNode(e);t!=null&&t.scope&&(s.scope=t.scope),t!=null&&t.context&&(s.context=t.context),t.after(s),this.nodesToDestroy.push(t.nextSibling)}}customElements.define("db-input",w);class S extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super();const t=this;this.state={stylePath:"components/button/button-web-component.css",handleClick(e){t.props.onClick&&t.props.onClick(e)},iconVisible(e){return e&&e!=="_"&&e!=="none"}},this.props||(this.props={}),this.componentProps=["onClick","type","disabled","label","className","icon","icntxt","size","state","width","variant","children","text","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.onButtonDbButton1Click=e=>{this.state.handleClick(e)},this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
      ...
      </button>`,this.pendingUpdate=!0,this.render(),this.onMount(),this.pendingUpdate=!1,this.update()}showContent(t){const e=t.content.cloneNode(!0);Array.from(e.childNodes).forEach(n=>{t!=null&&t.scope&&(n.scope=t.scope),t!=null&&t.context&&(n.context=t.context),this.nodesToDestroy.push(n)}),t.after(e)}attributeChangedCallback(t,e,s){this.props[t]=s,this.update()}static get observedAttributes(){return["text","variant","icon","icntxt","width"]}onMount(){this.props.stylePath&&(this.state.stylePath=this.props.stylePath,this.update())}onUpdate(){}update(){this.pendingUpdate!==!0&&(this.pendingUpdate=!0,this.render(),this.onUpdate(),this.pendingUpdate=!1)}render(){this.destroyAnyNodes(),this.updateBindings()}updateBindings(){this._root.querySelectorAll("[data-el='button-db-button-1']").forEach(t=>{this.props.type&&t.setAttribute("type",this.props.type),this.props.disabled&&t.setAttribute("disabled",this.props.disabled),this.props.label&&t.setAttribute("aria-label",this.props.label),t.className="db-button"+(this.props.className?" "+this.props.className:"")+(this.state.iconVisible(this.props.icon)&&!this.props.icntxt?" is-icon-text-replace":""),this.props.size&&t.setAttribute("data-size",this.props.size),this.props.state&&t.setAttribute("data-state",this.props.state),this.props.width&&t.setAttribute("data-width",this.props.width),this.props.variant&&t.setAttribute("data-variant",this.props.variant),t.removeEventListener("click",this.onButtonDbButton1Click),t.addEventListener("click",this.onButtonDbButton1Click)}),this._root.querySelectorAll("[data-el='show-db-button']").forEach(t=>{this.state.stylePath&&this.showContent(t)}),this._root.querySelectorAll("[data-el='link-db-button-1']").forEach(t=>{t.setAttribute("href",this.state.stylePath)}),this._root.querySelectorAll("[data-el='show-db-button-2']").forEach(t=>{this.state.iconVisible(this.props.icon)&&this.showContent(t)}),this._root.querySelectorAll("[data-el='db-icon-db-button']").forEach(t=>{this.props.icon&&t.setAttribute("icon",this.props.icon),this.props.icntxt&&t.setAttribute("icntxt",this.props.icntxt)}),this._root.querySelectorAll("[data-el='div-db-button-2']").forEach(t=>{this.renderTextNode(t,this.props.text)})}renderTextNode(t,e){const s=document.createTextNode(e);t!=null&&t.scope&&(s.scope=t.scope),t!=null&&t.context&&(s.context=t.context),t.after(s),this.nodesToDestroy.push(t.nextSibling)}}customElements.define("db-button",S);const _=()=>(window.addEventListener("load",()=>{const o=document.querySelector("#db-input"),t=document.querySelector("#db-button"),e=document.querySelector("#db-input-container");o&&(o.props.onChange=s=>{e.innerHTML=s.target.value}),t&&(t.props.onClick=()=>{alert(JSON.stringify({input:o.state._value}))})}),`
	...
	`),T=()=>(window.addEventListener("load",()=>{const o=document.querySelector("#select-variant"),t=Array.from(document.querySelectorAll("db-button"));o&&o.addEventListener("change",e=>{for(const s of t)s.setAttribute("variant",e.target.value)})}),`
	<div>
		<h1>Button</h1>
	...
	</div>`),g=()=>document.location.search.slice(1).split("&").filter(o=>(o==null?void 0:o.length)>0).reduce((o,t)=>{const e=t.split("=");return{...o,[e[0]]:e[1]}},{}),x=()=>(window.addEventListener("load",()=>{const o=g();["primary","secondary","success","critical","warning","information"].some(t=>t.includes(o.color??""))?document.querySelector("#backgroundWarning").style.display="block":document.querySelector("#backgroundWarning").style.display="none"}),`
	<div>
		<h1>Input</h1>
	...
	</div>`),f={button:"/button",input:"/input"},c=[{path:"/",label:"Home",component:_},{path:f.button,label:"Button",component:T},{path:f.input,label:"Input",component:x}];class C extends HTMLElement{get _root(){return this.shadowRoot||this}constructor(){super(),this.state={stylePath:"components/page/page-web-component.css"},this.props||(this.props={}),this.componentProps=["className","type","children","stylePath"],this.nodesToDestroy=[],this.pendingUpdate=!1,this.attachShadow({mode:"open"})}destroyAnyNodes(){this.nodesToDestroy.forEach(t=>t.remove()),this.nodesToDestroy=[]}connectedCallback(){this.getAttributeNames().forEach(t=>{const e=t.replace(/-/g,""),s=new RegExp(e,"i");this.componentProps.forEach(n=>{if(s.test(n)){const i=this.getAttribute(t);this.props[n]!==i&&(this.props[n]=i)}})}),this._root.innerHTML=`
	...
	<db-page type="fixedHeaderFooter">
		<db-header slot="header">
			...
			<div id="content" class="${y()}">
				${o}
			</div>
		<div slot="footer">Footer</div>
	</db-page>
`,D=()=>{const o=c.filter(t=>t.path!=="/").find(t=>window.location.href.includes(t.path));return o?o.component():c[0].component()};document.querySelector("#app").innerHTML=U(D());
